package web.dockertest.dockermodule.webtestclasses;
...
import web.dockertest.dockermodule.webpageclasses.HomeScreen;
...
public class TC_Docker extends BaseClass {
	...
	public TC_Docker() throws Exception {
		PropertyConfigurator.configure("log4j.properties");
		logger = Logger.getLogger(TC_Docker.class);
		configFileObj = new ConfigFilesUtility();
		configFileObj.loadPropertyFile("tc_docker.properties");
		reports = ExtentConfigurations.getExtentInstance(reportsPath, projectPath, HomeScreen.projectName);
		test = reports.startTest("TC_Docker");
	}
...
String text1 = objHomeScreen.clkAContact_297355();
